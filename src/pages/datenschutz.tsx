	...
	return (
		<div className='prose mx-auto text-justify'>
			...
			<p>
				...
				Lemberg e.V.. Eine Nutzung der Internetseiten des TV 1891 Lemberg e.V.
				ist grundsätzlich ohne jede Angabe personenbezogener Daten möglich.
				Sofern eine betroffene Person besondere Services unseres Vereines über
			...
			<p>
				...
				Übereinstimmung mit den für den TV 1891 Lemberg e.V. geltenden
				landesspezifischen Datenschutzbestimmungen. Mittels dieser
				Datenschutzerklärung möchte unser Verein die Öffentlichkeit über Art,
			...
			<p>
				Der TV 1891 Lemberg e.V. hat als für die Verarbeitung Verantwortlicher
			...
			<p>
				Die Datenschutzerklärung des TV 1891 Lemberg e.V. beruht auf den
			...
			<p>
				oder für die Verarbeitung Verantwortlicher Verantwortlicher oder für die
			...
			<p>
				...
				66969 Lemberg <br />
				Deutschland <br />
				E-Mail: info@tv-lemberg.de <br /> Website: www.tv-lemberg.de
			</p>
			<h2>3. Cookies</h2>
			<p>
				Die Internetseite des TV 1891 Lemberg e.V. verwendet Cookies. Cookies
			...
			<p>
				Durch den Einsatz von Cookies kann der TV 1891 Lemberg e.V. den Nutzern
			...
			<p>
				Die Internetseite des TV 1891 Lemberg e.V. erfasst mit jedem Aufruf der
			...
			<p>
				Bei der Nutzung dieser allgemeinen Daten und Informationen zieht der TV
				1891 Lemberg e.V. keine Rückschlüsse auf die betroffene Person. Diese
				...
				erhobenen Daten und Informationen werden durch den TV 1891 Lemberg e.V.
				daher einerseits statistisch und ferner mit dem Ziel ausgewertet, den
				Datenschutz und die Datensicherheit in unserem Verein zu erhöhen, um
			...
			<p>
				Die Internetseite des TV 1891 Lemberg e.V. enthält aufgrund von
				gesetzlichen Vorschriften Angaben, die eine schnelle elektronische
				Kontaktaufnahme zu unserem Verein sowie eine unmittelbare Kommunikation
				mit uns ermöglichen, was ebenfalls eine allgemeine Adresse der
				sogenannten elektronischen Post (E-Mail-Adresse) umfasst. Sofern eine
			...
			<h3>§b) Recht auf Auskunft</h3> Jede von der Verarbeitung
			<p>
			...
			<p>
				...
				Person die Löschung von personenbezogenen Daten, die beim TV 1891
				Lemberg e.V. gespeichert sind, veranlassen möchte, kann sie sich hierzu
				jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen
				wenden. Der Mitarbeiter des TV 1891 Lemberg e.V. wird veranlassen, dass
				dem Löschverlangen unverzüglich nachgekommen wird. Wurden die
				personenbezogenen Daten vom TV 1891 Lemberg e.V. öffentlich gemacht und
				ist unser Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO
				zur Löschung der personenbezogenen Daten verpflichtet, so trifft der TV
				1891 Lemberg e.V. unter Berücksichtigung der verfügbaren Technologie und
				...
				erforderlich ist. Der Mitarbeiter der TV 1891 Lemberg e.V. wird im
			...
			<p>
				...
				personenbezogenen Daten, die bei der TV 1891 Lemberg e.V. gespeichert
				...
				Mitarbeiter der TV 1891 Lemberg e.V. wird die Einschränkung der
			...
			<p>
				...
				betroffene Person jederzeit an einen Mitarbeiter des TV 1891 Lemberg
				e.V. wenden.
			</p>
			...
			<p>
				...
				gestütztes Profiling. Der TV 1891 Lemberg e.V. verarbeitet die
				...
				Ausübung oder Verteidigung von Rechtsansprüchen. Verarbeitet Der TV 1891
				Lemberg e.V. personenbezogene Daten, um Direktwerbung zu betreiben, so
				...
				gegenüber dem TV 1891 Lemberg e.V. der Verarbeitung für Zwecke der
				Direktwerbung, so wird Der TV 1891 Lemberg e.V. die personenbezogenen
				Daten nicht mehr für diese Zwecke verarbeiten. Zudem hat die betroffene
				Person das Recht, aus Gründen, die sich aus ihrer besonderen Situation
				ergeben, gegen die sie betreffende Verarbeitung personenbezogener Daten,
				die beim TV 1891 Lemberg e.V. zu wissenschaftlichen oder historischen
				...
				die betroffene Person direkt jeden Mitarbeiter des TV 1891 Lemberg e.V.
			...
			<p>
				...
				Einwilligung der betroffenen Person, trifft Der TV 1891 Lemberg e.V.
			...
			<p>
				Art. 6 I lit. a DS-GVO dient unserem Verein als Rechtsgrundlage für
