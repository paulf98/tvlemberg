			...
			<PageWrapper>
				<div className='flex flex-col flex-wrap md:flex-nowrap gap-4 items-center'>
					<div className='text-justify flex-1'>
						<p>
							Unser diesjähriges, traditionelles Zeltlager findet in der Zeit
							vom Mittwoch, 18. Juni bis Samstag, 21. Juni 2025 (Fronleichnam)
							in Lemberg auf dem Turngelände statt.
						</p>
						...
						<p>
							Unternehmungslustige Kinder ab 6 Jahre und Jugendliche mit Freude
							an Gemeinschaft, Spielen und Abenteuer sollten sich
				...
				<ul className='text-left'>
					...
					<li>
						Christine Gebhard, Karlstr. 17, 66969 Lemberg, Tel.-Nr.
						0176/32001620
					</li>
					<li>
