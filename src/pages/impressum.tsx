export default function Impressum() {
	return (
		<div className='prose mx-auto text-justify py-4'>
			...
			<h4>
				Turnverein 1891 Lemberg e.V. <br />
				Fischweiherstr. 29 66969 Lemberg <br />
				Info@tv-lemberg.de <br />
				Vereinsregisternummer VR20314
			</h4>
			Verantwortlich für Design und Technik:
			<h4>Turnverein 1891 Lemberg e.V.</h4>
			<h2 className='mt-8'>Haftungsausschluss</h2>
			...
			Haftungsverpflichtung ausschließlich in dem Fall in Krafttreten, in dem
			...
			verhindern.Der Autor erklärt hiermit ausdrücklich, dass zum Zeitpunkt der
			...
			Videosequenzen und Texte zunutzen oder auf lizenzfreie Grafiken,
			...
			gültigen Kennzeichen rechts und den Besitzrechten der jeweiligen
